...
showMeals("https://www.themealdb.com/api/json/v1/1/search.php?s=","")
let searchMeals = $("#searchMeals");
$("#searchByName").on("input", function () {
    showMeals('https://www.themealdb.com/api/json/v1/1/search.php?s=',this.value);
});

$("#searchByFirst").on("input", function () {
    showMeals('https://www.themealdb.com/api/json/v1/1/search.php?f=',this.value);
});
 ...
 async function showMeals(apiLink,val) {
